...
Good documentation doesn't require extensive effort.
A well-structured minimal documentation already makes your project:
...
The goal isn't perfection but clarity.
...
Combined with proper licensing and version control (covered in the [Using Git in Academia](https://t4d-gmbh.github.io/using-git-in-academia/) course), this foundation ensures your research software can be understood and reused.
